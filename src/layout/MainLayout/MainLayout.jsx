...
const MainLayout = () => {
  ...
  const isSubMenuActive = () =>
    ["talktime", "gameCards", "internet", "giftCard"].includes(activeMenu);
    ...
    <Box sx={{ p: 2, boxSizing: "border-box", height: "Calc(100vh - 32px)" }}>
      <div style={{ display: "flex" }}>
        <Sidebar
          collapsed={collapsed}
          collapsedWidth="80px"
          style={{ height: "auto", boxShadow: "0px 2px 3px 0px #0000001A", borderRadius: "10px", }}
        >
          <div
            style={{
              display: "flex",
            ...
            >
              {["talktime", "gameCards", "internet", "giftCard"].map((item) => (
                <MenuItem
                  ...
                  style={{
                    borderLeft: activeMenu === item ? "2px solid #FC2861" : "",
                    color: activeMenu === item ? "#FC2861" : "#969696",
                    fontWeight: 700,
                    fontSize: "16px",
                    lineHeight: "21px",
                    fontFamily: '"Manrope", serif',
