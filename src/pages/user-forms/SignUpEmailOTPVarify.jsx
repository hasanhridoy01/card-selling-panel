...
const SignUpEmailOTPVarify = ({ email, reference }) => {
  ...
  const onSubmit = async (otp) => {
    ...
    let url = `/api/v1/public/sign-up/validate-email-otp`;
    ...
    if (response?.status > 199 && response?.status < 300) {
      handleSnakbarOpen("Email verified successfully", "success");
...
export default SignUpEmailOTPVarify;
